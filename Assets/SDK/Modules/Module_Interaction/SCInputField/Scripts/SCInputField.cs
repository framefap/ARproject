...
namespace SC.XR.Unity
{
        ...
        ILayoutElement
    {
        ...
        [SerializeField]
        private SCKeyboardEnum m_SCKeyboardEnum = SCKeyboardEnum.SCKeyboard3D;

        [SerializeField]
        private bool m_UseCustomTransform;

        [SerializeField]
        private Vector3 m_CustomPosition;

        [SerializeField]
        private Vector3 m_CustomRotation;

        [SerializeField]
        private Vector3 m_CustomLocalScale;
        ...
        public int characterLimit { get { return m_CharacterLimit; } set { if (SCSetPropertyUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value))) UpdateLabel(); } }
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (true) //(TouchScreenKeyboard.isSupported)
            {
                ...
                m_Keyboard.keyboardMono.stringBuilder.Clear();
                m_Keyboard.keyboardMono.stringBuilder.Append(text);
                m_Keyboard.keyboardMono.SetTextString();
        ...
        {
            Transform head = SvrManager.Instance.head.transform;
