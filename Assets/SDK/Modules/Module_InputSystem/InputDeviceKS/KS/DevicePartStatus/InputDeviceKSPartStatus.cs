        ...
        protected virtual bool UpdateDeviceInfo(InputDeviceKSPart part,bool isClear=false) {
            ...
            try {
                ...
                if (part.PostureType == PostureType.UnKown) {
                    if (part.inputDataKS.GCType == GCType.K11) {
                        part.PostureType = PostureType._3Dof;
                        DebugMy.LogError("K11 Use 3Dof:" + part.inputDataKS.GCType, this);
                    } else if (part.inputDataKS.GCType == GCType.K102 || part.inputDataKS.GCType == GCType.K101) {
